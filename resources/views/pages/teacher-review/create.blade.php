...
@section('title')
    <title>Review toevoegen | ToolHub</title>
@endsection
    ...
    <div class="container mt-4 pb-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Review toevoegen</li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-12">
                <h2 class="mb-0"><strong>Review toevoegen</strong></h2>
            </div>
        </div>
        ...
        {{ Form::open(['route' => ['tools.teacherreview.store', $tool->slug]]) }}
            ...
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    <select name="positives[]" class="select2 w-100" multiple="multiple">
                        @foreach ((!is_null(old('positives'))) ? old('positives') : [] as $positive)
            ...
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    <select name="negatives[]" class="select2 w-100" multiple="multiple">
                        @foreach ((!is_null(old('negatives'))) ? old('negatives') : [] as $negative)
