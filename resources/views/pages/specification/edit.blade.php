...
@section('title')
    <title>Specificatie wijzigen | ToolHub</title>
@endsection
  ...
  <div class="container mt-4 pb-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Specificatie wijzigen</li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-12">            
                <h2 class="mb-0"><strong>Specificatie wijzigen</strong></h2>
            </div>
        </div>
        ...
        <div class="alert alert-warning" role="alert">
            <strong>Let op!</strong> Bij het wijzigen van een specificatie worden automatisch alle tools bijgewerkt naar de nieuwe specificatie.
        </div>

        {{ Html::ul($errors->all()) }}

        {{ Form::model($specification, array('route' => array('specifications.update', $specification->slug), 'method' => 'PUT')) }}
               

        <div class="form-group">
            {{ Form::label('name', 'Naam  *') }}
            {{ Form::text('name', $specification->name, array('class' => 'form-control')) }}
        </div>
